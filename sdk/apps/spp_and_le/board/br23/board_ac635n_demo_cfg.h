...
//                                 USER配置                                        //
//*********************************************************************************//
#define TCFG_ADC_DETECTION_HEART            IO_PORTB_03                             //心电adc采集io口
#define TCFG_ADC_DETECTION_HEART_CH         AD_CH_PB3                               //心电adc采集通道口

#define TCFG_ECG_MCU_OUT_PIN                IO_PORTB_11                             //心电供电使能io口
#define TCFG_ECG_DROP_OUT_PIN               IO_PORTB_04                             //心电防脱落检测io口
#define TCFG_ECG_DROP_OUT_CH                AD_CH_PB4                             //心电防脱落检测io口

#define TCFG_BUZZER_PIN                     IO_PORTB_02                             //心电蜂鸣器io口

#define TCFG_LCD_NV3022B_ENABLE             ENABLE
...
//                                  RTC_ALARM配置                                  //
//*********************************************************************************//
#define TCFG_RTC_ALARM_ENABLE               1//DISABLE_THIS_MOUDLE
...
//                                 adkey 配置                                      //
//*********************************************************************************//
#define TCFG_ADKEY_ENABLE                   0//ENABLE_THIS_MOUDLE //DISABLE_THIS_MOUDLE //是否使能AD按键
