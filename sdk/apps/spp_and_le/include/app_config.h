...
#define LCD_CS_PORT   		            IO_PORTC_01                                                                                 /* Chip enable select pin   L: Command H: Data*/
#define LCD_CS_SLECT_ENABLE() 			do{gpio_set_die(LCD_CS_PORT, 1);gpio_set_direction(LCD_CS_PORT, 0);gpio_set_pull_down(LCD_CS_PORT, 0);\
	                  			        gpio_set_pull_up(LCD_CS_PORT, 0);gpio_set_output_value(LCD_CS_PORT,0);}while(0)
#define LCD_CS_SLECT_DISABLE() 			do{gpio_set_die(LCD_CS_PORT, 1);gpio_set_direction(LCD_CS_PORT, 0);gpio_set_pull_down(LCD_CS_PORT, 0);\
	                  			        gpio_set_pull_up(LCD_CS_PORT, 0);gpio_set_output_value(LCD_CS_PORT,1);}while(0)

#define LCD_RS_PORT   		            IO_PORTC_03                                                                                   /*Register select signal   H:DATA,   L:COMMAND*/
#define LCD_RS_DATA() 			        do{gpio_set_die(LCD_RS_PORT, 1);gpio_set_direction(LCD_RS_PORT, 0);gpio_set_pull_down(LCD_RS_PORT, 0);\                                  
	                  			        gpio_set_pull_up(LCD_RS_PORT, 0);gpio_set_output_value(LCD_RS_PORT,1);}while(0)                                       
#define LCD_RS_COMMON() 			    do{gpio_set_die(LCD_RS_PORT, 1);gpio_set_direction(LCD_RS_PORT, 0);gpio_set_pull_down(LCD_RS_PORT, 0);\
	                  			        gpio_set_pull_up(LCD_RS_PORT, 0);gpio_set_output_value(LCD_RS_PORT,0);}while(0)

#define LCD_RST_PORT   		            IO_PORTC_02                                                                                   /*RESET*/
#define LCD_RST_H() 			        do{gpio_set_die(LCD_RST_PORT, 1);gpio_set_direction(LCD_RST_PORT, 0);gpio_set_pull_down(LCD_RST_PORT, 0);\                                  
	                  			        gpio_set_pull_up(LCD_RST_PORT, 0);gpio_set_output_value(LCD_RST_PORT,1);}while(0)                                       
...
#define LCD_FHIO_L() 			        do{gpio_set_die(LCD_FHIO_PORT, 1);gpio_set_direction(LCD_FHIO_PORT, 0);gpio_set_pull_down(LCD_FHIO_PORT, 0);\
	                  			        gpio_set_pull_up(LCD_FHIO_PORT, 0);gpio_set_output_value(LCD_FHIO_PORT,0);}while(0)
...
#define CONFIG_APP_SPP_LE_TO_IDLE          1 //SPP_AND_LE To IDLE Use
