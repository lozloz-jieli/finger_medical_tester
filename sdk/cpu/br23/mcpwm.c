...
static u8 pwm_hw_h_pin[6] = {IO_PORTA_00, IO_PORTB_00, IO_PORTA_08, IO_PORTB_09, IO_PORTA_09, IO_PORTC_04};
...
#define PWM_CH5_ENABLE 		1
    ...
    pwm_p_data.duty = 5000;                                 //占空比50%
    //hw
    pwm_p_data.h_pin = IO_PORTA_08;                                  //没有则填 -1。h_pin_output_ch_num无效，可不配置
    //output_channel
